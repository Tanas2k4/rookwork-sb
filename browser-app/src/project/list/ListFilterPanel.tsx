...
export function ListFilterPanel({
  ...
  const count =
    selectedStatuses.length + selectedUsers.length + selectedTypes.length;
              ...
              <div className="space-y-1.5">
                {typeOptions.map((t) => (
                  ...
                  >
                    ...
                    />
                    <span
                      className={`px-2 py-0.5 text-xs font-medium rounded-full flex items-center gap-1.5 ${t.color}`}
                    >
                      {t.icon}
                      {t.label}
                    </span>
